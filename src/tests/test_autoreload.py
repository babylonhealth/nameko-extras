...
from nameko_extras import autoreload
...
@patch('nameko_extras.autoreload.os')
@patch('nameko_extras.autoreload.sys')
class TestReloader:

    @patch('nameko_extras.autoreload._restart_application_with_autoreload')
    ...
    @patch('nameko_extras.autoreload._monitor_needs_reloading')
...
class TestCodeHasChanged:
    ...
    @patch('nameko_extras.autoreload.os')
    @patch('nameko_extras.autoreload._generate_known_filenames')
...
class TestMonitorNeedsReloading:
    ...
    @patch('nameko_extras.autoreload._ensure_echo_on')
    @patch('nameko_extras.autoreload._code_has_changed')
